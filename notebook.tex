...
\documentclass[11pt]{article}
    ...
    \def\lt{<}
    % Document parameters
    \title{Chapter00 - Table Of Contents}
...
\makeatother
    ...
    The material consists of two parts, Python and R for SAS users.~These
chapters are meant to be read in order (within the respective part) as
they start with foundational concepts used to build up more complex
ideas.

Part 1 Python for SAS Users

~

Chapter00 -~Preface~

Chapter01 -~Table of Contents~
...
Chapter 4 -~Understanding Indexes
...
Chapter 5 - Hierarchical Indexing
...
Chapter 7 -~Date, Time and Timepart Objects
...
Chapter 8 -~Panda Time Series and Date Handling
...
Chapter 10 -~Panda Readers

pd.read\_csv(URL) method

SQLAlchemy Under the Covers

read\_sql\_table() method

read\_sql\_query()method

DataFrame.to\_sql() method

pd.read\_sas() method

Resources

Chapter 11~-~Additional Data Handling
